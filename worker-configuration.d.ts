/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 73d9dca0745811e1231719d4690eccf3)
// Runtime types generated with workerd@1.20260714.1 2026-02-24 nodejs_compat
interface __BaseEnv_Env {
  ASSETS: Fetcher;
  ENVIRONMENT: 'staging' | 'production' | 'development';
  SITE_URL: 'https://staging.example.invalid' | 'https://example.invalid' | 'http://localhost:8787';
  ACCESS_TEAM_DOMAIN: '';
  ACCESS_AUD: '';
  TURNSTILE_SITE_KEY: '';
